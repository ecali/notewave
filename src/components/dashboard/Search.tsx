    ...
    return (
        <div className='w-full h-[50px] my-4 '>
            <div className='flex flex-row w-full h-full rounded-lg overflow-hidden relative items-center bg-eerie-black '>
                ...
                <svg onClick={() => handleSearch('')} className="w-6 h-6 absolute right-0 pr-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
